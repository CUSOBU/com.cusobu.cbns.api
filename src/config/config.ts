...
const MONGO_URL =
  ...
  `mongodb+srv://cubanitos:Cuba901208@cluster0.djq68l7.mongodb.net/cubanitos`;
...
const WALAK_API_URL =
  process.env.WALAK_API_URL || "https://api.dev.walak.app/api/mlc";
const WALAK_API_KEY =
...
export const config = {
  ...
  WALAK_API_KEY: WALAK_API_KEY,
  WALAK_API_URL: WALAK_API_URL
};
